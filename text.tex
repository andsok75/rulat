...
— Cto angel sletel s nebes? Posledni{\y} angel, kotorovo, kak govor{\ia}t, videli, po{\y}avl{\ia}lsa, kogda rasp{\ia}li Christa, i izvestil namestnika, deda emperatora Constantina, o tom, cto gr{\ia}dut bolyxi{\y}e peremen{\yi}. No v to{\y} istori{\y}i hot{\ia} b{\yi} b{\yi}l serieusn{\yi}{\y} povod.
...
— Vrode b{\yi} ob{\yi}cn{\yi}{\y}e l{\iu}di nas videty ne doljn{\yi}. — {\Y}evo pelican{\y}e sv{\ia}te{\y}xestvo pl{\iu}hnulsa na mo{\y}u krovaty.
...
— Horoxo, — legko soglasilsa on, b{\yi}stro ogl{\ia}devxisy i udostoverivxisy, cto nikto ne obra{\x}a{\y}et na nas vnimani{\y}a. — {\Y}a uznal obo vs{\e}m etom davno, kogda {\y}e{\x}o b{\yi}l molod{\yi}m. Malenyki{\y} sluh, broxenna{\y}a phrasa na odnom iz balov vedym. {\Y}a zainteresovalsa, stal raskrucivaty nitocku. Nabl{\iu}dal, rasspraxival. Daje v mo{\y}om soob{\x}estve informati{\y}i b{\yi}lo malo, {\y}a dovolystvovalsa lix sluhami i mythami, bolyxinstvo iz kotor{\yi}h okazalisy v{\yi}dumko{\y}. No {\y}a ne sdavalsa, nahodil collectionerov star{\yi}h knig, pose{\x}al castn{\yi}{\y}e bibliotheci i daje {\y}ezdil v Temnoles{\y}e.
...
— No t{\yi} i ne prodal {\y}evo. — Kristina ne spraxivala, utverjdala. — T{\yi} slixkom um{\e}n, ctob{\yi} razbras{\yi}vatsa podobn{\yi}mi podarkami i ostavl{\ia}ty ih v lombarde. Uverena, cto kak vsegda hranix na deposite v ``Fabien Clemence", ctob{\yi} vz{\ia}ty v l{\iu}bo{\y} moment.
...
— Nebolyxa{\y}a. — Apothekary ponizil golos. — M{\yi} s Walterom pridumali i osu{\x}estvili grandiosnu{\y}u affairu, sociniv, cto angel snizoxol v etot gorod.
...
— V{\yi} zate{\y}ali eto, ctob{\yi} v{\yi}manity Urbana, tak kak Caruso pod {\y}evo pokrovitelystvom, i on ne mog proignorirovaty tako{\y}e sob{\yi}ti{\y}e i ne pri{\y}ehaty s{\iu}da.
...
— Mogu govority tolyko za seb{\ia}. Ne ponima{\y}u, kak pri ogromnom steceni{\y}i naroda i clericah mojno ukrasty ve{\x} u cardinala… I bo{\y}usy za tvo{\y}u jizny. Vozmojno, {\y}a oxiba{\y}usy, no skazaty ob etom — pravilyno, i t{\yi} doljen b{\yi}ty v curse mo{\y}ih razm{\yi}xleni{\y}.
...
— T{\yi} sam sebe protivorecix, Ludwig. To ``ne sume{\y}et", to ``mojet". Pocemu b{\yi} tebe vs{\e}-taki ne otdaty im to, cto u teb{\ia} {\y}esty, i ne vput{\yi}vatsa v serieusn{\yi}{\y}e nepri{\y}atnosti? V Riapano jivut opasn{\yi}{\y}e l{\iu}di. Sto{\y}it li perebegaty im dorogu?
...
— No {\y}esli eto b{\yi}l ne Walter, a kto-to ino{\y}, to slucivxe{\y}esa na plo{\x}adi — sovpadeni{\y}e? Commanda zagovor{\x}ikov, p{\yi}tavxihsa ubity cardinala, i neizvestn{\yi}{\y}, rexivxi{\y} ustro{\y}ity localn{\yi}y apocalypsis?

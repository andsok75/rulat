...
— Tvo{\y}evo druga Nathana. Pred{\yi}stori{\y}a takova. Dostopoctim{\yi}{\y} Adily aly Djuma, blagodar{\ia} svo{\y}im sv{\ia}z{\ia}m v torgovle, mnogo{\y}e sl{\yi}xit. Daje to, cto p{\yi}ta{\y}utsa skr{\yi}ty ot {\y}evo uxe{\y}. Do nevo doxol sluh o tom, cto v Veliko{\y} pust{\yi}ne lovki{\y}e l{\iu}di ot{\yi}skali dva corn{\yi}h kamn{\ia} i privezli na nax kontinent.
...
— Tret{\y}e. Ne i{\x}i t{\e}mnovo kuzne{\c}a. Inace on pridet i za tobo{\y}. Kak prixol za nami. Pokl{\ia}nisy!

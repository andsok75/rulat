...
— Nascot adskih vrat? Vpolne vozmojno. No odno ne otmen{\ia}{\y}et drugovo. Pohoje, on de{\y}stvitelyno i{\x}et temnovo mastera. I {\y}esli ne dl{\ia} ubi{\y}stva, to dl{\ia} svo{\y}ih {\c}ele{\y}. Ili c{\yf}ih-to {\y}e{\x}e. Kristina uverena, cto oni pocti naxli kuzne{\c}a. Razumno b{\yi}lo b{\yi} nahoditsa r{\ia}dom s nimi.
